...
export function RadarPulse({ className }) {
    return (
        <div className={cn("relative w-full h-auto", className)}>
            <svg width="1452" height="733" viewBox="0 0 1452 733" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
                <g id="Ecosystem" clipPath="url(#clip0_1_2)">
                    <g id="eco-radar">
                        {/* Radar base circle with pulse animation */}
                        <g id="radar">
                            <motion.circle
                                id="Ellipse 1"
                            ...
                            {/* Pulse rings - Sequential appearance */}
                            <motion.circle
                        ...
                        >
                            <motion.circle
                                ...
                                stroke="#434141"
                                whileHover={{ scale: 1.15, stroke: "#63B3ED" }}
                ...
                <defs>
                    ...
                    <radialGradient id="paint0_radial_1_2" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(725.5 639.5) rotate(92.6422) scale(457.5)">
                        <stop offset="0.278846" stopColor="#1A1A1A" />
                        <stop offset="1" stopColor="#3A3A3A" />
                    </radialGradient>

                    <linearGradient id="paint1_linear_1_2" x1="787" y1="569.074" x2="654" y2="689.926" gradientUnits="userSpaceOnUse">
