...
export const BackgroundBeamsWithCollision = ({
    ...
    return (
        <div
            ref={parentRef}
            className={cn(
                "h-96 md:h-[40rem] bg-gradient-to-b from-blue-300 to-blue-600 dark:from-neutral-950 dark:to-neutral-800 relative flex items-center w-full justify-center overflow-hidden",
        ...
        <div {...props} className={cn("absolute z-50 h-2 w-2", props.className)}>
            ...
            {spans.map((span) => (
                <motion.span
                    ...
                    className="absolute h-1 w-1 rounded-full bg-gradient-to-b from-neutral-100 to-neutral-500" />
            ))}
        </div>
    );
};
