...
export const NavbarButton = ({
    ...
    const variantStyles = {
        ...
        dark: "inline-flex items-center gap-2 rounded-xl bg-gradient-to-b from-neutral-400/20 to-neutral-800/20 border border-dark-grid px-4 py-2 text-neutral-300",
        gradient:
